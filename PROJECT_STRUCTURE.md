...
3. Android 텍스트·JPEG 선택/공유 import debug slice
4. Android debug slice와 Figma UI 명세의 자동검증
...
원자 저장합니다. JPEG 사진 정규화도 구현되어 있습니다. `apps/android/`에는 Figma v1을
따른 Compose 화면과 WCT1/pinned TLS/pending 저장 경로가 있으며, 실기기 수용시험 전까지
자동검증을 진행합니다. iPhone 앱과 viewer UI는 아직 구현하지 않았습니다.
